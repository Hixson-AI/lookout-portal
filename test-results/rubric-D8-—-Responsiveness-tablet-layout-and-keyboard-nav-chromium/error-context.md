  ...
  - generic [ref=e4]:
    ...
    - generic [ref=e7]:
      ...
      - button "Help" [ref=e17] [cursor=pointer]:
        - img [ref=e18]
      - button "Save workflow (Ctrl+S)" [ref=e21] [cursor=pointer]:
        - img [ref=e22]
        - text: Save
  - toolbar "Keyboard shortcuts" [ref=e26]:
    - generic [ref=e27]: ⌘S save
    - generic [ref=e28]: ⌘Z undo
    - generic [ref=e29]: Del remove
  - generic [ref=e31]:
    - generic [ref=e32]:
      - generic [ref=e33]:
        - heading "Workflow Settings" [level=3] [ref=e35]
        - generic [ref=e36]:
          - generic [ref=e37]:
            - generic [ref=e38]: Name
            - textbox "My Workflow" [ref=e39]: Customer Inquiry Handler
          - generic [ref=e40]:
            - generic [ref=e41]: Description
            - textbox "Describe what this workflow does" [active] [ref=e42]: Receives a customer inquiry via webhook, classifies it with AI, then routes to email or SMS.
          - generic [ref=e43]:
            - generic [ref=e44]: Trigger
            - combobox [ref=e45]:
              ...
              - option "▶️ Manual"
          - generic [ref=e46]:
            - generic [ref=e47]: Webhook URL
            - generic [ref=e48]:
              - img [ref=e49]
              - code [ref=e52]: "/webhooks/{id} — save to activate"
      - generic [ref=e53]:
        - heading "Secrets Encrypted at rest" [level=3] [ref=e55]:
          - img [ref=e56]
          - text: Secrets
          - generic [ref=e59]:
            - img [ref=e60]
        ...
        - generic [ref=e63]:
          - generic [ref=e64]:
            - textbox "Secret key name" [ref=e65]:
              - /placeholder: SECRET_KEY
            - textbox "Secret value" [ref=e66]:
              - /placeholder: secret value
            - button "Add Secret" [disabled]:
              - img
              - text: Add Secret
          - paragraph [ref=e67]: ⚠️ Save the workflow first to manage secrets.
          - generic [ref=e68]:
            - paragraph [ref=e69]: "Usage in steps:"
            - code [ref=e70]: "{{SECRET_NAME}}"
            - paragraph [ref=e71]: "Reference any secret in step config fields using the {{KEY}} syntax."
    - generic [ref=e73]:
      - generic [ref=e75]:
        - heading "Workflow Canvas" [level=3] [ref=e76]
        - button "Help" [ref=e77] [cursor=pointer]:
          - img [ref=e78]
      - generic [ref=e82]:
        - generic:
          - img
        ...
        - generic [ref=e83]:
          - button "AI Assist" [ref=e84] [cursor=pointer]:
            - img [ref=e85]
            - text: AI Assist
          - button "🌐 API + AI template" [ref=e88] [cursor=pointer]
          - button "📧 Notify template" [ref=e89] [cursor=pointer]
    - generic [ref=e91]:
      - generic [ref=e92]:
        - heading "Step Catalog" [level=3] [ref=e93]
        - textbox "Search steps…" [ref=e94]
      - generic [ref=e95]:
        - button "🌐 HTTP Request Call any REST API" [ref=e96]:
          - generic [ref=e97]:
            - generic [ref=e98]: 🌐
            - generic [ref=e99]:
              - generic [ref=e100]: HTTP Request
              - generic [ref=e101]: Call any REST API
        - button "🤖 AI Processing Run an LLM prompt" [ref=e102]:
          - generic [ref=e103]:
            - generic [ref=e104]: 🤖
            - generic [ref=e105]:
              - generic [ref=e106]: AI Processing
              - generic [ref=e107]: Run an LLM prompt
        - button "🔄 Data Transform Reshape or filter data" [ref=e108]:
          - generic [ref=e109]:
            - generic [ref=e110]: 🔄
            - generic [ref=e111]:
              - generic [ref=e112]: Data Transform
              - generic [ref=e113]: Reshape or filter data
        - button "🔀 Condition/Branch True/false branching" [ref=e114]:
          - generic [ref=e115]:
            - generic [ref=e116]: 🔀
            - generic [ref=e117]:
              - generic [ref=e118]: Condition/Branch
              - generic [ref=e119]: True/false branching
        - button "⏱️ Delay Wait N milliseconds" [ref=e120]:
          - generic [ref=e121]:
            - generic [ref=e122]: ⏱️
            - generic [ref=e123]:
              - generic [ref=e124]: Delay
              - generic [ref=e125]: Wait N milliseconds
        - button "📧 Email Send Send transactional email" [ref=e126]:
          - generic [ref=e127]:
            - generic [ref=e128]: 📧
            - generic [ref=e129]:
              - generic [ref=e130]: Email Send
              - generic [ref=e131]: Send transactional email
        - button "💬 Twilio SMS Send SMS via Twilio" [ref=e132]:
          - generic [ref=e133]:
            - generic [ref=e134]: 💬
            - generic [ref=e135]:
              - generic [ref=e136]: Twilio SMS
              - generic [ref=e137]: Send SMS via Twilio
```
